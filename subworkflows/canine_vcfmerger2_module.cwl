...
steps:
  ...
  canine_collect_somatic_metrics_module:
    ...
    out: [mutation_burdern_txt_snpeff, mutation_burdern_json_snpeff, tucon_snpeff, mutation_burdern_txt_vep, mutation_burdern_json_vep, tucon_vep, msisensor_metrics]
