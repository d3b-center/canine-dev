...
outputs:
  ...
  denoised_cr_gender_corrected: { type: 'File', outputSource: awk_gender_correction/denoisedcr_corr}
  model_final_seg_gender_corrected: { type: 'File', outputSource: awk_gender_correction/modelfinal_corr }
  cna_plots: { type: 'File[]', outputSource: plotCNVplus/plots }
  dlrs: { type: 'File', outputSource: plotCNVplus/dlrs }
  recentered_cr_seg: { type: 'File', outputSource: plotCNVplus/recentered_seg }
  recentered_cr_seg_vcf: { type: 'File', outputSource: annotSeg/output }
...
steps:
  ...
  awk_interval:
    ...
    in:
      ...
      max_length: awk_bamstats/max_length
    out: [min_interval]
  ...
  expr_gatk_cnv_variables:
    ...
    in:
      exome:
        ...
        valueFrom: |
          $(self == "Exome")
      bamstats_max_length: awk_bamstats/max_length
      intervals_min_interval: awk_interval/min_interval
      normal_average_depth: awk_bamstats/normal_average_depth
      tumor_average_depth: awk_bamstats/tumor_average_depth
  ...
  plotCNVplus:
    ...
    out: [plots, recentered_seg, dlrs]

  annotSeg:
    run: ../tools/annotSeg.cwl
    in:
      input_annotation_gtf: annotation_gtf
      input_file: plotCNVplus/recentered_seg
      amp_threshold:
        valueFrom: $(0.58)
      del_threshold:
        valueFrom: $(-0.99)
