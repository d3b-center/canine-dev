  ...
  - class: InitialWorkDirRequirement
    ...
    - entryname: temp_rna_header.sh 
      ...
      entry: |
        ...
        echo "##fileformat=VCFv4.2" > $(inputs.output_filename) 
        ...
        echo $'#CHROM\tPOS\tID\tREF\tALT\tQUAL\tFILTER\tINFO' >> $(inputs.output_filename)

baseCommand: [/bin/bash, temp_rna_header.sh]

inputs:
  output_filename: { type: 'string?', default: "temp_RNA.vcf", doc: "Name for output header file" }
