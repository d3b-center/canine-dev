...
inputs:
  ...
  output_filename: { type: 'string', inputBinding: { position: 2, prefix: "--output" }, doc: "Write output to FILE" }
  ...
  reference_fasta: { type: 'File?', inputBinding: { position: 2, prefix: "--reference" }, doc: "Reference sequence FASTA FILE" }
