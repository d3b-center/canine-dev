...
inputs:
  ...
  nonmonomer_max: { type: 'int?', inputBinding: { position: 22, prefix: '-I' }, doc: "The maximum non-monomer MSI allowed for a HT variant with AF < 0.6. By default, 12, or any variants with AF < 0.6 in a region with > 12 non-monomer MSI will be considered false positive. For monomers, that number is 10." }
