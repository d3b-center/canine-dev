...
steps:
  ...
  canine_add_matched_rna:
    run: ../sub_workflows/canine_add_matched_rna.cwl
  ...
  canine_add_rna_header_to_vcf_module:
    run: ../sub_workflows/canine_add_rna_header_to_vcf_module.cwl
    in:
      input_vcf: vcfmerger2/vcf
      output_filename:
        source: output_basename
  ...
  canine_collect_somatic_metrics_module:
    run: ../sub_workflows/canine_collect_somatic_metrics_module.cwl
    in:
