...
outputs:
  sbs_activity: { type: 'File?', outputSource: coyote_sigprofiler/sbs_activity }
  sbs_activity_plot: { type: 'File?', outputSource: coyote_sigprofiler/sbs_activity_plot }
  sbs_tmb_plot: { type: 'File?', outputSource: coyote_sigprofiler/sbs_tmb_plot }
  sbs_dnm_prob: { type: 'File?', outputSource: coyote_sigprofiler/sbs_dnm_prob }
  sbs_dn_sigs: { type: 'File?', outputSource: coyote_sigprofiler/sbs_dn_sigs }
  id_activity: { type: 'File?', outputSource: coyote_sigprofiler/id_activity }
  id_activity_plot: { type: 'File?', outputSource: coyote_sigprofiler/id_activity_plot }
  id_tmb_plot: { type: 'File?', outputSource: coyote_sigprofiler/id_tmb_plot }
  id_dnm_prob: { type: 'File?', outputSource: coyote_sigprofiler/id_dnm_prob }
  id_dn_sigs: { type: 'File?', outputSource: coyote_sigprofiler/id_dn_sigs }
  dbs_activity: { type: 'File?', outputSource: coyote_sigprofiler/dbs_activity }
  dbs_activity_plot: { type: 'File?', outputSource: coyote_sigprofiler/dbs_activity_plot }
  dbs_tmb_plot: { type: 'File?', outputSource: coyote_sigprofiler/dbs_tmb_plot }
  dbs_dnm_prob: { type: 'File?', outputSource: coyote_sigprofiler/dbs_dnm_prob }
  dbs_dn_sigs: { type: 'File?', outputSource: coyote_sigprofiler/dbs_dn_sigs }
